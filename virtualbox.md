# VirtualBox support for packer-officeVM

As long as VirtualBox is default provider the usage is short. All you need is Windows ISO file passed into [build.ps1](build.ps1) script.
